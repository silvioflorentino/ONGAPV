...
--
-- Host: 127.0.0.1
-- Generation Time: 28-Out-2021 às 02:13
...
(14, 'kkkkk', '', 'kkk@k', '1231231231', '12121230', '$2y$08$8xaBZ.XfLxN3jLLw7fIw0.GLGGvZl5LTATevJlnUKXyaIsQVYmWJq', b'0');
...
CREATE TABLE `tb_emp_parceiras` (
  ...
  `tel_emp_parceria` int(15) NOT NULL,
...
(6, 'Avenida', 'João Gonçalves', '4878', 'Itapegica', 'Guarulhos', '04598-895', '75.782.021/0175-86', 'empresateste123@gmail.com', 'FL Brasil Industria e Comercios Ltda', 'Bauducco', 0, 'empresateste.com.br', '$2y$08$6aC4dKhWivXrjMIiUavHp.twXDvPutHLVajRQzKbdD/AJqEj3YoNG');
...
(6, 'Nossa Senhora de Fátima', 0, 'Rua', 'Tarcis Bueno', '235', 'Jardim Santa Lídia', 'Guarulhos', '04578-895', 'senhorafatima132@teste.com', 'www.nossasenhora.com', '$2y$08$O4CWNdbHzdqULyhFc2pDg.01UY4e6U72i2Owyfy3ZuKTXu2kJsyYW');
...
(13, 'Antônia Ferreira de Oliveira', 0, 'antoniaferreira@gmail.com', '134.569.569-89', 'João Alvares', '21', '12065-895', '02/11/2005', 'Entregar_Doacoes', '$2y$08$x6qxkImIIRgxbL7s2TMnfe9aRJ1h7Vpkj6CwrWBexXlP1W65Hofjy'),
(14, 'hhhhh', 0, 'hhhh@h', '12312312344', 'rua h', '12', '22333333', '11223333', 'Entregar_Doacoes', '$2y$08$sJ9ZggG8QBN3z2jFVtM4cefcJOqAaho3Jw1lr9xwmpwaxVFz43q0C');
...
--
-- Indexes for table `tb_doadores`
--
ALTER TABLE `tb_doadores`
  ADD PRIMARY KEY (`id_doador`);

--
-- Indexes for table `tb_emp_parceiras`
--
ALTER TABLE `tb_emp_parceiras`
  ADD PRIMARY KEY (`id_emp`);

--
-- Indexes for table `tb_grupos_vulneraveis`
--
ALTER TABLE `tb_grupos_vulneraveis`
  ADD PRIMARY KEY (`id_grupo`);

--
-- Indexes for table `tb_item_doacao`
--
...
--
-- Indexes for table `tb_parcerias`
--
ALTER TABLE `tb_parcerias`
  ADD PRIMARY KEY (`id_parc`);

--
-- Indexes for table `tb_tel_doador`
--
...
--
-- Indexes for table `tb_tp_doacao`
--
ALTER TABLE `tb_tp_doacao`
  ADD PRIMARY KEY (`id_tp_doacao`);

--
-- Indexes for table `tb_voluntarios`
--
...
--
-- AUTO_INCREMENT for table `tb_doacao`
--
ALTER TABLE `tb_doacao`
  MODIFY `id_doacao` int(3) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tb_doadores`
--
ALTER TABLE `tb_doadores`
  MODIFY `id_doador` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `tb_emp_parceiras`
--
ALTER TABLE `tb_emp_parceiras`
  MODIFY `id_emp` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `tb_grupos_vulneraveis`
--
ALTER TABLE `tb_grupos_vulneraveis`
  MODIFY `id_grupo` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `tb_item_doacao`
--
ALTER TABLE `tb_item_doacao`
  MODIFY `id_item_doacao` int(4) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tb_parcerias`
--
ALTER TABLE `tb_parcerias`
  MODIFY `id_parc` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `tb_tel_doador`
--
ALTER TABLE `tb_tel_doador`
  MODIFY `id_tel_doador` int(3) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tb_tel_emp`
--
ALTER TABLE `tb_tel_emp`
  MODIFY `id_tel_emp` int(3) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tb_tel_parc`
--
ALTER TABLE `tb_tel_parc`
  MODIFY `id_tel_parc` int(3) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tb_tel_vol`
--
ALTER TABLE `tb_tel_vol`
  MODIFY `id_tel_vol` int(3) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tb_tp_doacao`
--
ALTER TABLE `tb_tp_doacao`
  MODIFY `id_tp_doacao` int(2) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tb_voluntarios`
--
ALTER TABLE `tb_voluntarios`
  MODIFY `id_vol` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
